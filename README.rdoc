...
use_rake_test:: uses 'rake test' instead of 'rake gemtest' (see below). Potentially dangerous, do not use for more than testing. 
...
upload_results:: upload results to http://rubygems.org. Incomplete feature as of this writing.
...
* Create a +gemtest+ Rake target that runs all or a subset of your tests that can be consumed by any user without any additional configuration.
